...
class RegisterForm extends AuthForm
{
    ...
    public function setup(): void
    {
        ...
        $this
            ...
            ->when(CarRentalsHelper::isMultiVendorEnabled(), function (RegisterForm $form) {
                $form->add(
                    'is_vendor',
                    RadioField::class,
            ...
            ->add(
                ...
                CheckboxFieldOption::make()
                    ->when(
                        $privacyPolicyUrl = theme_option('car_rentals_term_and_privacy_policy_url') ?: theme_option('term_and_privacy_policy_url'),
